 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '29771','63549','54646','59068','45107','34641',
                          '66096','39301','14183','32455','57893',
                          '95151','84575','17188','50121','99429',
                          '74728','28870','90836','54041','60747',
                          '54529','24475','38039','16114','52851',
                          '37370','42908','11089','19357','29660',
                          '10688','10732','41101','63289','54724',
                          '76563','94180','56092','55886','20996',
                          '14501','89132','33092','55697','99895',
                          '15462','44930','15345','98647','78295',
                          '87352','44117','18959','18268','25308',
                          '33475','18224','15410','60612','72809',
                          '26355','13627','90301','25533','33615',
                          '28967','51467','71531','57255','84414',
                          '64238','10508','34530','36531','11472',
                          '15363','77393','92306','76602','76406',
                          '23367','60836','45348','42171','73932',
                          '48166','16492','23853','55499','22210',
                          '69243','36224','28073','37767','85361',
                          '44202','21266','29356','32658','22438',
                          '44782','39207','71638','14838','91391',
                          '17589','10798','20498','17684','48871',
                          '46054','19504','48486','12708','34901',
                          '25544','73274','69734','54347','96046',
                          '50862','69777','26727','59755','72153',
                          '99879','48028','10465','82619','93223',
                          '33795','29097','23181','14512','23811',
                          '28533','15690','13013','52237','33959',
                          '59549','64891','61170','60112','98519',
                          '27422','40064','47452','84069','47273',
                          '95864','84870','18282','98664','52280',
                          '54771','99939','98443','59452','19314',
                          '84248','63921','13832','35394','14942',
                          '13866','14080','17939','70651','82269',
                          '21509','89869','98403','66452','22122',
                          '77188','29426','88621','92468','30783',
                          '16680','59830','55942','71874','27543',
                          '42735','30250','83332','44400','67866',
                          '22964','49987','28862','53121','34897',
                          '93022','75691','69985','17398','10347',
                          '24882','35479','35487','79146','68876',
                          '72691','71159','84078','30778','98459',
                          '63593','23169','31629','34085','22474',
                          '62564','21699','92974','86052','38065',
                          '28287','76940','97187','38305','19904',
                          '95832','30127','21476','40827','38577',
                          '21260','13584','32651','36965','78402',
                          '56408','88076','91166','38366','84856',
                          '71175','91709','97288','26571','92279',
                          '58602','68670','78984','95595','91501',
                          '32107','18175','13084','81674','17875',
                          '58367','86279','49695','31002','16660',
                          '43235','56729','12513','54393','27994',
                          '70778','64163','34417','27127','26257',
                          '74215','95343','19147','30148','42777',
                          '90845','50443','28880','77680','98869',
                          '67876','49225','24173','44396','82492',
                          '81504','41855','53964','16599','81535',
                          '52613','15270','99343','95960','63315',
                          '22411','15245','13984','17396','56156',
                          '40331','11463','13608','36589','82483',
                          '31792','75839','19021','20117','41560',
                          '91485','18796','20782','55582','95301',
                          '71722','40735','23110','63423','80600',
                          '43093','22719','63603','89251','67412',
                          '62433','25649','32688','47688','50984',
                          '56866','38279','13030','89782','38392',
                          '39214','36149','13326','20353','56199',
                          '40506','34429','58988','60037','42618',
                          '55887','62271','86180','25973','39603',
                          '25038','80834','97242','41092','92400',
                          '36931','97293','29125','87716','14575',
                          '14882','94258','41720','24043','22382',
                          '80395','24779','22197','76744','99469',
                          '43004','49353','68758','76078','13638',
                          '82232','91009','75487','99156','39581',
                          '27595','41450','36620','82768','22455',
                          '17883','66710','97757','11729','95195',
                          '88697','22297','76986','44515','67288',
                          '87120','17642','62741','21472')
     intersect
      select ca_zip
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 37245
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 6213
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 2178
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 147
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 41516
            then (select avg(ss_ext_sales_price)
                  from store_sales
...
select  
 ...
 where
  ...
  ca_county in ('Dunn County','Beaufort County','Pierce County','Camas County','Martin County') and
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('OH', 'KY', 'MO')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('IA', 'AL', 'FL')
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (2,7,10,6,1,8) and
       d_year = 2000 and
...
select  i_item_id
 ...
 and d_date between cast('2000-03-06' as date) 
 				and (cast('2000-03-06' as date) + 30 days)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 9 and 9+10
          or ss_coupon_amt between 13295 and 13295+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 93 and 93+10
          or ss_coupon_amt between 4834 and 4834+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 57 and 57+10
          or ss_coupon_amt between 1807 and 1807+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 120 and 120+10
          or ss_coupon_amt between 13232 and 13232+1000
...
select  i_item_id
 ...
 and i_manufact_id in (838,775,691,995)
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('sienna','midnight','lemon'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2000
 and     d_moy                   = 1
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('sky','pink','dodger','burnished','gainsboro','brown') and
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2000
 	and t_time between 44830 and 44830+28800 
...
select  i_item_id
 ...
 and i_manufact_id in (572,244,58,478)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2002-05-19','2002-09-04','2002-11-13')))
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Clinton'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  60070
   and ib_upper_bound   <=  60070 + 50000
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2001) and
        ((i_category in ('Electronics','Women','Children') and
          i_class in ('scanners','dresses','newborn')
         )
      or (i_category in ('Men','Shoes','Music') and
          i_class in ('sports-apparel','womens','pop') 
        ))

...
- `host` (optional): The host address used for the connection.
- `port` (optional): The port used for the connection.
- `user` (optional): The username used for the connection.
- `password` (optional): The password used for the connection.
- `conneted_database_name` (optional): The database name used for the connection.
...
- `user` (optional): The username used for the connection.
- `password` (optional): The password used for the connection.
- `database_name` (optional): The database name used for the connection.

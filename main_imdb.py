...
# nohup python ./main_imdb.py --config ./exp_configs/exp_config_imdb.json > ./main_imdb.log 2>&1 &
# nohup python ./main_imdb.py --config ./exp_configs/exp_config_imdb_plus.json > ./main_imdb_plus.log 2>&1 &
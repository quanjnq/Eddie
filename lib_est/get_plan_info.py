"""
This file is copied from the implementation of [Index_EAB].
Source code: https://github.com/XMUDM/Index_EAB/blob/main/index_advisor_selector/index_benefit_estimation/benefit_utils/get_plan_info.py
"""

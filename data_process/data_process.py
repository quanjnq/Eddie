...
def data_preprocess(dataset_path, db_stat_path, log_label=False, random_change_tbl_col=False, clip_label=True):
    ...
    for si, sample in enumerate(src_data):
        ...
        if orig_plan and "Actual Total Time" in orig_plan:
        ...
        if with_index_plan and "Actual Total Time" in with_index_plan:
            with_index_runtimes = with_index_plan["Actual Total Time"] if "Actual Total Time" in with_index_plan else with_index_runtimes

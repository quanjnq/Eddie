...
from selection import cost_evaluation
...
class SelectionAlgorithm:
    def __init__(self, database_connector, parameters, default_parameters=None):
        ...
        if "CostEvaluation" in parameters:
            self.cost_evaluation = parameters["CostEvaluation"]
        else:
            self.cost_evaluation = cost_evaluation.CostEvaluation(database_connector)
